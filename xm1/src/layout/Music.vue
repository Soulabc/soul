<template>
            ...
            <div class="player__top">
                <div class="player-cover">
                    <transition-group :name="transitionName">
                          <div class="player-cover__item" v-show="$index === currentTrackIndex" :style="{ backgroundImage: `url(${track.cover})` }" v-for="(track, $index) in tracks" :key="$index"></div>
                    </transition-group>
                </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" hidden xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <symbol id="icon-infinity" viewBox="0 0 32 32">
          ...
          <path d="M29.312 20.832c-1.28 1.28-3.008 1.984-4.832 1.984s-3.52-0.704-4.832-1.984c-0.032-0.032-0.224-0.224-0.256-0.256v0 1.28c0 0.448-0.352 0.8-0.8 0.8s-0.8-0.352-0.8-0.8v-3.168c0-0.448 0.352-0.8 0.8-0.8h3.168c0.448 0 0.8 0.352 0.8 0.8s-0.352 0.8-0.8 0.8h-1.28c0.032 0.032 0.224 0.224 0.256 0.256 0.992 0.992 2.304 1.536 3.68 1.536 1.408 0 2.72-0.544 3.68-1.536 0.992-0.992 1.536-2.304 1.536-3.68s-0.544-2.72-1.536-3.68c-0.992-0.992-2.304-1.536-3.68-1.536-1.408 0-2.72 0.544-3.68 1.536l-8.416 8.448c-1.312 1.312-3.072 1.984-4.832 1.984s-3.488-0.672-4.832-1.984c-2.65
...
export default {
   ...
   data:function(){
       return{
           ...
           tracks: [{
                   /* 因为切换等按钮用的svg网络组件，所以切换下一首歌的时候需要等待5s左右的加载，请两位莫急 */
                   name: "Everybody Knows",
                   /* 歌手 */
                   artist: "Leonard Cohen",
                   /* 歌名 */
                   cover: "'/static/img/t1.png'",
                   /* 图片地址，此处可以引入后端数据或者本地，我这块弄得是本地 */
                   source: "'https://i.y.qq.com/v8/playsong.html?songid=247631521&source=yqq#wechat_redirect'",
                   /* 音频地址，此处可以引入后端数据或者网络连接 */
                   url: "#",
                   /* 分享地址，可忽略 */
                   favorited: false
                       /* 这个是心,true变红，false变灰，已经设置好了可以点击自动切换 */
               },
               {
                   name: "Mekanın Sahibi",
                   artist: "Norm Ender",
                   cover: "'/static/img/t2.png'",
                   source: "'/static/img/t2.mp3'",
                   url: "#",
                   favorited: false
               },
               {
                   name: "未知",
                   artist: "过河DJ版",
                   cover: "'/static/img/t3.png'",
                   source: "'/static/img/t3.mp3'",
                   url: "#",
                   favorited: false
               },
               {
                   name: "未知",
                   artist: "你莫走",
                   cover: "'/static/img/t4.png'",
                   source: "'/static/img/t4.mp3'",
                   url: "#",
                   favorited: false
               },
               {
                   name: "浪姐",
                   artist: "狂浪",
                   cover: "'/static/img/t5.png'",
                   source: "'/static/img/t5.mp3'",
                   url: "#",
                   favorited: false
               }
           ],
